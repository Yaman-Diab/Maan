...
/// نفس بنية `VerifyEmailHeader` بنصوص التدفّق تبع الاستعادة — المستخدم
/// هون بيستعيد حسابه لا بيأكّد بريده لأول مرة، فالنص لازم يعكس هيك.
